		...
		<div id="main" style="width:78%;float:left;" >
			...
			<div class="" id="makecomplaint" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
				...
				<form class="form" action="usermakecomp.php" method="POST" style="width:100%;" enctype="multipart/form-data">
					<span id="span2">TARGET DEPARTMENT :</span>
					<select id="category" name="category" style="width:30%;border-radius:12px;height:37px;"> 
						<option>Health Services</option>
						<option>Water and Energy</option>
						<option>Finance and Economic planning </option>
						<option>Public service & Devolution</option>
						<option>Roads, Transport and Public Works</option>
						<option>Education, Gender, Youths, and Sports</option>
						<option>Trade, Marketing, Tourism & Industrialization</option>
						<option>Lands, Housing and Physical Planning Department</option>
						<option>Agriculture, Livestock, Veterinary Services, Fisheries & Cooperative Development</option>
						<option>ENVIRONMENT, NATURAL RESOURCES, CLIMATE CHANGE AND DISASTER MANAGEMENT</option>
					</select>
					...
					<br /><span id="span">Additional Attachments (If any) Max Size 2Mb</span><input name="f2" type="file" class="form-control" >
				<br />
